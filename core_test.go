...
func TestGameRenderToBuffer(t *testing.T) {
	...
	// Save to PNG
	imagePath := "/tmp/test_game_render.png"
...
func TestBufferComposition(t *testing.T) {
	...
	// Save result
	imagePath := "/tmp/test_buffer_composition.png"
...
func TestMultiLayerRendering(t *testing.T) {
	...
	// Save final result
	imagePath := "/tmp/test_multi_layer.png"
	err := finalBuffer.Save(imagePath)
	if err != nil {
	...
	terrainBuffer.Save("/tmp/test_layer_terrain.png")
	unitBuffer.Save("/tmp/test_layer_units.png")
	uiBuffer.Save("/tmp/test_layer_ui.png")
	...
	if _, err := os.Stat(imagePath); os.IsNotExist(err) {
		...
		t.Logf("Terrain layer: /tmp/test_layer_terrain.png")
		t.Logf("Units layer: /tmp/test_layer_units.png")
		t.Logf("UI layer: /tmp/test_layer_ui.png")
	}
	
	// Clean up
	os.Remove(imagePath)
	os.Remove("/tmp/test_layer_terrain.png")
	os.Remove("/tmp/test_layer_units.png")
	os.Remove("/tmp/test_layer_ui.png")
}