...
class GameSyncServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                request_serializer=weewar_dot_v1_dot_models_dot_sync__pb2.SubscribeRequest.SerializeToString,
                response_deserializer=weewar_dot_v1_dot_models_dot_sync__pb2.GameUpdate.FromString,
                _registered_method=True)
        self.Broadcast = channel.unary_unary(
                '/weewar.v1.GameSyncService/Broadcast',
                request_serializer=weewar_dot_v1_dot_models_dot_sync__pb2.BroadcastRequest.SerializeToString,
                response_deserializer=weewar_dot_v1_dot_models_dot_sync__pb2.BroadcastResponse.FromString,
                _registered_method=True)
...
def add_GameSyncServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    servicer.Subscribe,
                    request_deserializer=weewar_dot_v1_dot_models_dot_sync__pb2.SubscribeRequest.FromString,
                    response_serializer=weewar_dot_v1_dot_models_dot_sync__pb2.GameUpdate.SerializeToString,
            ),
            'Broadcast': grpc.unary_unary_rpc_method_handler(
                    servicer.Broadcast,
                    request_deserializer=weewar_dot_v1_dot_models_dot_sync__pb2.BroadcastRequest.FromString,
                    response_serializer=weewar_dot_v1_dot_models_dot_sync__pb2.BroadcastResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'weewar.v1.GameSyncService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('weewar.v1.GameSyncService', rpc_method_handlers)
...
class GameSyncService(object):
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/weewar.v1.GameSyncService/Subscribe',
            weewar_dot_v1_dot_models_dot_sync__pb2.SubscribeRequest.SerializeToString,
            weewar_dot_v1_dot_models_dot_sync__pb2.GameUpdate.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Broadcast(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/weewar.v1.GameSyncService/Broadcast',
            weewar_dot_v1_dot_models_dot_sync__pb2.BroadcastRequest.SerializeToString,
            weewar_dot_v1_dot_models_dot_sync__pb2.BroadcastResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
