...
# Build script for turnengine_v1_services WASM module

set -e

echo "Building turnengine_v1_services WASM module..."
...
go build -o turnengine_v1_services.wasm turnengine_v1_services.wasm.go
...
echo "  - turnengine_v1_services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("turnengine_v1_services.wasm"), go.importObject)'
