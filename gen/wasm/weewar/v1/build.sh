...
# Build script for services WASM module

set -e

echo "Building services WASM module..."
...
go build -o services.wasm services.wasm.go
...
echo "  - services.wasm          (WASM binary)"
...
echo '  WebAssembly.instantiateStreaming(fetch("services.wasm"), go.importObject)'
