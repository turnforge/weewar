...
export class Turnengine_v1_servicesClient {
     ...
     */
    public async loadWasm(wasmPath: string = './turnengine_v1_services.wasm'): Promise<void> {
    ...
    private async loadWASMModule(wasmPath: string): Promise<void> {
        console.log('Loading turnengine_v1_services WASM module...');
        ...
        console.log('turnengine_v1_services WASM module loaded successfully');
    }
...
class CoordinatorServiceClientImpl implements CoordinatorServiceMethods {
    constructor(private parent: Turnengine_v1_servicesClient) {}
...
export default Turnengine_v1_servicesClient;