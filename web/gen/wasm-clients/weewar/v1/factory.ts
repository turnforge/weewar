...
export class WeewarV1Factory {
  ...
  /**
   * Enhanced factory method for TileClickedRequest
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newTileClickedRequest = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<TileClickedRequestInterface> => {
    const out = new ConcreteTileClickedRequest();
  ...
  /**
   * Enhanced factory method for TileClickedResponse
   * @param parent Parent object containing this field
   * @param attributeName Field name in parent object
   * @param attributeKey Array index, map key, or union tag (for containers)
   * @param data Raw data to potentially populate from
   * @returns Factory result with instance and population status
   */
  newTileClickedResponse = (
    parent?: any,
    attributeName?: string,
    attributeKey?: string | number,
    data?: any
  ): FactoryResult<TileClickedResponseInterface> => {
    const out = new ConcreteTileClickedResponse();
